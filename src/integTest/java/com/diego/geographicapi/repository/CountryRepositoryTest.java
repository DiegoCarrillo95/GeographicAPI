...
public class CountryRepositoryTest {
	...
	@Test
	public void shouldReturnCountryWhenfindByCountryCodeMethodIsCalledWithExistingCountryCode() {
		Country insertedCountry = countryRepository.save(country);
		
		Country returnedCountry = countryRepository.findByCountryCode("BR");
		
		assertEquals(insertedCountry, returnedCountry);	
	}
